...
<li class="nav-item active">
    <a class="nav-link" href="index.php">
        ...
        <span><h3>𝐏𝐚𝐧𝐞𝐥 𝐝𝐞 𝐂𝐨𝐧𝐭𝐫𝐨𝐥</h3></span></a>
</li>
...
<!-- EMPIEZA EL NAVBAR -->
       <div id="content-wrapper" class="d-flex flex-column"  >
        ...
        <!-- <div class="text-right mb-2">
            <a href="../views/pdf/PruebaV.php" target="_blank" class="btn btn-success"><i class="fas fa-file-pdf"></i>Generar reporte</a>
        </div> -->
